...
require('telescope').setup {
  defaults = {
    ...
    file_ignore_patterns = { "node_modules" }, -- Moved inside defaults
  },
  pickers = { -- Moved inside setup
    find_files = {
      theme = "dropdown",
    },
    diagnostics = {
...
vim.keymap.set('n', '<leader>sf', telescope_live_grep_open_files, { desc = '[S]earch [/] in Open Files' })
